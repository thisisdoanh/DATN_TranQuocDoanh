...
class BetterPlayerCustomProgressBar extends StatefulWidget {
  BetterPlayerCustomProgressBar(
    this.controller,
...
class _VideoProgressBarState extends State<BetterPlayerCustomProgressBar> {
  ...
  @override
  void didUpdateWidget(covariant BetterPlayerCustomProgressBar oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onHorizontalDragStart: (DragStartDetails details) {
        if (!controller!.value.initialized || enableProgressBarDrag == false) {
          return;
        }
      ...
      onHorizontalDragEnd: (DragEndDetails details) {
        if (enableProgressBarDrag == false) {
          return;
        }
        ...
        child: Container(
          ...
          child: CustomPaint(
            painter: _ProgressBarPainter(
              _getValue() ??
                  VideoPlayerValue(duration: const Duration(seconds: 1)),
              widget.colors,
            ),
          ),
        ),
